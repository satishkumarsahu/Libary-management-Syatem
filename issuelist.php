...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `new_book` WHERE `mem_id`='$valueToSearch' OR `mem_name`='$valueToSearch' OR `issued_date`='$valueToSearch' OR `tosub`='$valueToSearch' OR `name`='$valueToSearch' OR `pub`='$valueToSearch' OR `year`='$valueToSearch'";
...
<html>
   ...
   table{
    ...
    <body>
        ...
        <form action="issuelist.php" method="post">
		<div class="back">
		<a href="BOOK_ISSUE.php"><img src="images\BACK.jpg"> </a>
		</div>
		<div class="value">
