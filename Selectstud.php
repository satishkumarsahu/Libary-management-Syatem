...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `stud_reg` WHERE `stud_id`='$valueToSearch' OR `stud_name`='$valueToSearch' OR `course`='$valueToSearch'";
...
<html>
   ...
   table{
    ...
    <body>
        ...
        <form action="Selectstud.php" method="post">
		<div class="back">
		<a href="STUDENTREG.php"><img src="images\BACK.jpg"> </a>
		</div>
		<div class="value">
      ...
      <!-- populate table from mysql database -->
                ...
                <tr>
                    <td><h3><center><?php echo $row['stud_id'];?></center></h3></td>
                    <td><h3><center><?php echo $row['stud_name'];?></center></h3></td>
                    <td><h3><center><?php echo $row['course'];?></center></h3></td>
                    <td><h3><center><?php echo $row['caste'];?></center></h3></td>
